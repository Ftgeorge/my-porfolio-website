...
export default function TypeOfGender() {
                ...
                <div className="w-6/12 h-screen bg-white flex justify-center">
                    <div className="my-60">
                        ...
                        <div className="w-12/12 mb-5">
                            <h1 className="my-2 text-black font-standard text-md mt-5">What’s your gender? </h1>
                        ...
                        <h1 className="text-[#8000FF] underline">We use this to improve your experience</h1>
                        <button
